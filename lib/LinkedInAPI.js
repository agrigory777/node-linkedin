...
module.exports = class LinkedInRestClient {
  ...
  /**
   * Post Share From People Account
   *
   * @param access_token
   * @returns {Promise<Object>}
   */
  async postShareFromPeopleAccount(access_token) {
    if (!access_token) throw new Error('Access code cannot be empty');
    // const url = `${this.url}/me`;
    return this.invoke('GET', url, undefined, undefined, { withAuth: true, access_token });
  }
  ...
  /**
   * Post Share From Company Account
   *
   * @param access_token
   * @returns {Promise<Object>}
   */
  async postShareFromCompanyAccount(access_token) {
    if (!access_token) throw new Error('Access code cannot be empty');
    // const url = `${this.url}/me`;
    return this.invoke('GET', url, undefined, undefined, { withAuth: true, access_token });
  }
  ...
  /**
   * Get Company Pages Data - get list of User Company Pages on LinkedIn
   *
   * @param access_token
   * @returns {Promise<Object>}
   */
  async getCompanyPagesData(access_token) {
    if (!access_token) throw new Error('Access code cannot be empty');
    // const url = `${this.url}/me`;
    return this.invoke('GET', url, undefined, undefined, { withAuth: true, access_token });
  }
  ...
  /**
   * Get Company Online Update Data
   *
   * @param access_token
   * @returns {Promise<Object>}
   */
  async getCompanyOnlineUpdateData(access_token) {
    if (!access_token) throw new Error('Access code cannot be empty');
    // const url = `${this.url}/me`;
    return this.invoke('GET', url, undefined, undefined, { withAuth: true, access_token });
  }
  ...
  /**
   * Get People Online Update Data
   *
   * @param access_token
   * @returns {Promise<Object>}
   */
  async getPeopleOnlineUpdateData(access_token) {
    if (!access_token) throw new Error('Access code cannot be empty');
    // const url = `${this.url}/me`;
    return this.invoke('GET', url, undefined, undefined, { withAuth: true, access_token });
  }
